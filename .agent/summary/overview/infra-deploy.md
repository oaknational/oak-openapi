...
- `infrastructure/bulk-upload/README.md` documents release and job execution details.
- `sequence-rules.md` documents subject/category sequencing rules relevant to API behavior.
