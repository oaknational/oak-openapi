...
- Start with index.md to find the topic file you want.
- Each file focuses on a single concern (architecture, data, CMS, etc.).
- If code or docs change, update the specific summary file and then update index.md.
- See `.agent/summary/deep-dives/deep-dive.md` for instructions, diagrams, explanations, and examples.
- Gap analysis and enhancement analysis live in `.agent/summary/analysis/`.
