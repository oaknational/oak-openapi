...
V0 vs V1 framing
- V0 (critical): prioritize reliability and trust for external users; see `.agent/summary/analysis/versioned-improvements.md` for the specific fix list.
- V1 (improvements): focus on polish, resilience, and maintainability after v0 stability goals are met.
- Dependency maintenance: patch/minor updates fit well in V0, while major upgrades are best planned for V1; see `.agent/summary/analysis/dependency-outdated-analysis.md`.
...
- Sequencing aids: `.agent/summary/analysis/v0-dependency-upgrade-checklist.md` and `.agent/summary/analysis/v1-upgrade-roadmap.md`.
