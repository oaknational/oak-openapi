module "job" {
  source = "github.com/oaknational/oak-terraform-modules//modules/gcp_job?ref=v2.3.0"
  ...
  job_service_account_email = data.terraform_remote_state.google_project.outputs.project_config.service_accounts["openapi-bulk-uploader-${local.project_env}"]
