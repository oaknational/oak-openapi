...
Key references
- V0/V1 framing: `docs/engineering/v0-v1-improvements.md`
- Gap analysis: `docs/engineering/gap-analysis.md`
- Enhancements: `docs/engineering/enhancements.md`
- Dependency tracking: `docs/engineering/dependency-upgrades.md`
- Onboarding: `docs/engineering/onboarding.md`
- Working on the repo: `docs/engineering/working-on-repo.md`
- First contribution: `docs/engineering/first-contribution.md`
- Safe change checklist: `docs/engineering/safe-change-checklist.md`
...
- v0-stabilization: all items in `docs/engineering/gap-analysis.md` are resolved or explicitly deferred.
...
Recommended usage
- Use `sprint-template.md` to outline a single sprint goal and scope.
- Use `release-checklist.md` for any release-candidate work.
- Use `upgrade-tracker.md` to track dependency batches and modernization items.
